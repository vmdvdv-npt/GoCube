...
const buildFrozenKnownAnswerCases = (): readonly Work9KnownAnswerCase[] => {
  ...
  const torusTopology = new TorusTopology(9);
  const cubeTopology = new CubeTopology(5);
  ...
  return Object.freeze([
    Object.freeze({
      ...
      targetPoint: firstStonePoint(torusTwoEye.state, torusTopology),
    ...
    Object.freeze({
      ...
      targetPoint: firstStonePoint(cubeTwoEye.state, cubeTopology),
      expectedStatus: 'alive',
      provenance: 'Frozen two-eye Benson fixture verified before Work 9.',
    }),
    Object.freeze({
      ...
      targetPoint: firstStonePoint(torusSingleEye.state, torusTopology),
    ...
    Object.freeze({
      ...
      targetPoint: firstStonePoint(cubeFalseEye.state, cubeTopology),
      expectedStatus: 'unresolved',

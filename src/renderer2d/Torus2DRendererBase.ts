...
export class Torus2DRenderer implements Renderer2D {
  ...
  private startPanAnimation(
    ...
    const animatedLayers = this.renderPanTransition(transitionScene, finalScene);
  ...
  private renderPanTransition(
    ...
    this.renderPanPresentation(transitionScene, piecesContent);
  ...
  /** Topology renderer subclasses may append current presentation geometry for pan frames. */
  protected renderPanPresentation(_scene: Torus2DScene, _target: SVGGElement): void {}

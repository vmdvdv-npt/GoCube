...
| first/second Pass | `cube4_vertex_capture_001`, `cube4_vertex_multiple_neighbor_capture_001`, `cube4_early_termination_boundary_001`, `cube4_nonempty_two_eye_score_001` | yes | yes | yes | no | yes | PASS | board/captures/player match at boundary; cleanup-phase sources excluded |
...
| manual setup scoring | `cube4_early_termination_boundary_001`, `cube4_nonempty_two_eye_score_001` | yes | yes | yes | yes | yes | PASS | empty and non-empty group review; Japanese komi, territory, stone, capture, prisoner and dead-stone components match V1 |
